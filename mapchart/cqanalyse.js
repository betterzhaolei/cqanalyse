...
**/
if(!self.getI18NString){self.getI18NString = function(s){return s;}}
...
var size = 10;
var circle = "../images/unit_small.gif";
var roundRect = "../images/unit_small.gif";
...
function onlayerchange(evt){
    ...
    Q.loadJSON("./mapchart/cqanalyse-status.json", function(json){
        lineStatus.forEach(function(line){
            graph.removeElement(line);
        });
...
//Q.loadJSON("./mapchart/cqanalyse.json?v=1.4", loadMetroDatas, showError);
Q.loadJSON("./mapchart/cqanalyse.json", loadMetroDatas, showError);
